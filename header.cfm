                ...
                <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                    ...
                    <li class="nav-item dropdown">
                        ...
                        <ul class="dropdown-menu" aria-labelledby="navbarDropdownStaff">
                            <li>
                                <a class="dropdown-item" href="index.cfm?fusebox=admin&fuseaction=dsp_stafflist">Manage Staff</a>
                            </li>
                            <li>
                                <a class="dropdown-item" href="index.cfm?fusebox=admin&fuseaction=dsp_upsertstaff">Add Staff</a>
                            </li>
                        </ul>
                    </li>
                    ...
                    <li>
                        <a class="nav-link" 
                        href="index.cfm?fusebox=MTRsec&fuseaction=act_logout" method="post">Logout</a>
