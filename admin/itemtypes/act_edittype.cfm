<cfif structKeyExists(FORM, "vaTYPENAME") AND Len(FORM.vaTYPENAME) GT 0>
    ...
    <cfstoredproc procedure="sspIMSCRTTypeWThreshold" datasource="#request.MTRDSN#" returncode="yes">
        <cfprocparam type="in" dbvarname="@as_operation" cfsqltype="cf_sql_nvarchar" value="EDIT">
        <cfprocparam type="in" dbvarname="@ai_typeid" cfsqltype="cf_sql_nvarchar" value="#FORM.iTYPEID#">
